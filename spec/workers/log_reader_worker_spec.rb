  ...
  describe '#perform' do
    ...
    context 'without any record for this day' do
      it 'delays LogLineParserWorker for each line in the log file' do
        expect(DailyViewsPerCountryUpdaterWorker).to receive(:perform_async).with(Time.at(1355880780), {"it"=>1, "us"=>93, "kr"=>14, "pa"=>1, "uk"=>2, "au"=>4, "ca"=>7, "do"=>1, "id"=>1, "tr"=>2, "mx"=>1, "nz"=>1, "kw"=>2, "fr"=>1, "pt"=>1, "za"=>2, "at"=>1, "bs"=>1, "th"=>1, "co"=>1, "be"=>1, "tw"=>1})
